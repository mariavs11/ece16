...
def get_data(directory, subject, trial, fs, bad_data):
  ...
  if(fs_est < fs-1 or fs_est > fs):
    ...
    bad_data = np.append(bad_data,filepath)
    dontUse = True
    print(bad_data)

  return t, ppg, hr, fs_est,bad_data, dontUse
...
if __name__ == "__main__":
  ...
  for subject in subjects:
    for trial in range(1,11):
      ...
      t, ppg, hr, fs_est, bad_data,__ = get_data(directory, subject, trial, fs, bad_data)
